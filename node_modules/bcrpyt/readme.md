...
when i use `npm install bcrypt` , but 404 , so i upload it from https://github.com/ncb000gt/node.bcrypt.js/

connect moeangel@qq.com or ipv4sec@gmail.com 

if some , i will delete it , just 4 convenient
